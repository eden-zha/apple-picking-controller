...
DATASET_REPO_ID="${RECORDED_YELLOW_DATASET_REPO_ID:-${RECORDED_DATASET_REPO_ID:-wyc/record_001}}"
DATASET_EPISODE="${RECORDED_YELLOW_DATASET_EPISODE:-${RECORDED_DATASET_EPISODE:-0}}"
