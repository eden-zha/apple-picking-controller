...
if defined RECORDED_YELLOW_DATASET_REPO_ID (
  set "DATASET_REPO_ID=%RECORDED_YELLOW_DATASET_REPO_ID%"
...
if defined RECORDED_YELLOW_DATASET_EPISODE (
  set "DATASET_EPISODE=%RECORDED_YELLOW_DATASET_EPISODE%"
...
echo Replaying recorded yellow action: !DATASET_REPO_ID! episode !DATASET_EPISODE!
